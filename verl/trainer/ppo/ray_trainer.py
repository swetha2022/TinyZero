...
class RayPPOTrainer(object):
    ...
    def _apply_hindsight_relabeling(self, batch: DataProto) -> DataProto:
        ...
        for i in range(len(batch)):
            ...
            prompt_ids = prompt_ids[-valid_prompt_len:]
            ...
            new_prompt_ids = self.tokenizer(relabeled_prompt, return_tensors='pt', add_special_tokens=False).input_ids[0]
            batch.batch['prompts'][i] = new_prompt_ids
